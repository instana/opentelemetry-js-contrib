...
describe('InstanaPropagator', () => {
  ...
  describe('.extract', () => {
    ...
    it('left-pads a 64-bit trace ID', () => {
      carrier = {
        [INSTANA_TRACE_ID_HEADER]: '4aaba1a52cf8ee09',
        [INSTANA_SPAN_ID_HEADER]: 'e457b5a2e4d86bd1',
        [INSTANA_LEVEL_HEADER]: '1',
      };
    ...
    it('left-pads the span ID if necessary', () => {
      carrier = {
        [INSTANA_TRACE_ID_HEADER]: '80f198ee56343ba864fe8b2a57d3eff7',
        [INSTANA_SPAN_ID_HEADER]: '7b5a2e4d86bd1',
        [INSTANA_LEVEL_HEADER]: '1',
      };
    ...
    it('handles malformed trace ID', () => {
      carrier = {
        [INSTANA_TRACE_ID_HEADER]: 'ghjklmnopqrstuvwxyz0123456789abc',
        [INSTANA_SPAN_ID_HEADER]: 'e457b5a2e4d86bd1',
        [INSTANA_LEVEL_HEADER]: '1',
      };
    ...
    it('handles malformed span ID', () => {
      carrier = {
        [INSTANA_TRACE_ID_HEADER]: '0f198ee56343ba864fe8b2a57d3eff7',
        [INSTANA_SPAN_ID_HEADER]: 'ghjklmnopqrstuv',
        [INSTANA_LEVEL_HEADER]: '1',
      };
    ...
    it('handles invalid trace ID', () => {
      carrier = {
        [INSTANA_TRACE_ID_HEADER]: INVALID_TRACEID,
        [INSTANA_SPAN_ID_HEADER]: 'e457b5a2e4d86bd1',
        [INSTANA_LEVEL_HEADER]: '1',
      };
    ...
    it('handles invalid span ID', () => {
      carrier = {
        [INSTANA_TRACE_ID_HEADER]: '80f198ee56343ba864fe8b2a57d3eff7',
        [INSTANA_SPAN_ID_HEADER]: INVALID_SPANID,
        [INSTANA_LEVEL_HEADER]: '1',
      };
